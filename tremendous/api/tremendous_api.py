...
class TremendousApi:
    ...
    def create_field(
        self,
        create_field_request: Annotated[CreateFieldRequest, Field(description="Field details")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param create_field_request: Field details (required)
        :type create_field_request: CreateFieldRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def create_field_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateField200Response]:
        """Create field
    ...
    def _create_field_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if create_field_request is not None:
            _body_params = create_field_request
    ...
    @validate_call
    def delete_connected_organization(
        self,
        id: Annotated[StrictStr, Field(description="ID of the connected organization to delete. ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of the connected organization to delete.  (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_connected_organization_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_connected_organization_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the connected organization to delete. ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_connected_organization_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the connected organization to delete. ")],
        _request_timeout: Union[
            None,
    ...
    def _delete_connected_organization_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def delete_connected_organization_member(
        self,
        id: Annotated[StrictStr, Field(description="ID of the connected organization member to remove. ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of the connected organization member to remove.  (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_connected_organization_member_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_connected_organization_member_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the connected organization member to remove. ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_connected_organization_member_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the connected organization member to remove. ")],
        _request_timeout: Union[
            None,
    ...
    def _delete_connected_organization_member_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_funding_source(
        self,
        id: Annotated[str, Field(strict=True, description="ID of the funding source that should be retrieved. Can also use `BALANCE` or `INVOICE` (case-insensitive) to retrieve the corresponding funding source.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def list_products(
        self,
        id: Annotated[Optional[StrictStr], Field(description="Comma-separated list of product IDs, used to only retrieve the provided products. Also accepts the special value `ALL_FEE_FREE`, which stands for every product in your catalog that carries no fee.")] = None,
        ...
        :param id: Comma-separated list of product IDs, used to only retrieve the provided products. Also accepts the special value `ALL_FEE_FREE`, which stands for every product in your catalog that carries no fee.
        :type id: str
