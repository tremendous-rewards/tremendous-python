...
class FundingSourceMeta(BaseModel):
    ...
    failure_details: Optional[FundingSourceMetaFailureDetails] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FundingSourceMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FundingSourceMeta from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "failure_details": FundingSourceMetaFailureDetails.from_dict(obj["failure_details"]) if obj.get("failure_details") is not None else None
        })
        return _obj
