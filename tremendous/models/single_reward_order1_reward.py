...
from tremendous.models.single_reward_order1_reward_custom_fields_inner import SingleRewardOrder1RewardCustomFieldsInner
from tremendous.models.single_reward_order1_reward_delivery import SingleRewardOrder1RewardDelivery
from typing import Optional, Set
from typing_extensions import Self

class SingleRewardOrder1Reward(BaseModel):
    """
    ...
    custom_fields: Optional[List[SingleRewardOrder1RewardCustomFieldsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SingleRewardOrder1Reward from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SingleRewardOrder1Reward from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "custom_fields": [SingleRewardOrder1RewardCustomFieldsInner.from_dict(_item) for _item in obj["custom_fields"]] if obj.get("custom_fields") is not None else None,
