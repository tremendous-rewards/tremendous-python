...
class OrderWithLinkRewardsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "order_id", "created_at", "expires_at", "campaign_id", "products", "value", "recipient", "deliver_at", "custom_fields", "delivery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderWithLinkRewardsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderWithLinkRewardsInner from a dict"""
        if obj is None:
            return None
