...
class ListBalanceTransactions200ResponseTransactionsInnerOrder(BaseModel):
    """
    Order details
    """ # noqa: E501
    ...
    payment: Optional[ListBalanceTransactions200ResponseTransactionsInnerOrderPayment] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListBalanceTransactions200ResponseTransactionsInnerOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListBalanceTransactions200ResponseTransactionsInnerOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "payment": ListBalanceTransactions200ResponseTransactionsInnerOrderPayment.from_dict(obj["payment"]) if obj.get("payment") is not None else None
        })
        return _obj
