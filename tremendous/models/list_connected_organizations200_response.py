...
class ListConnectedOrganizations200Response(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListConnectedOrganizations200Response from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in connected_organizations (list)
        _items = []
        if self.connected_organizations:
            for _item in self.connected_organizations:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListConnectedOrganizations200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "connected_organizations": [ListConnectedOrganizations200ResponseConnectedOrganizationsInner.from_dict(_item) for _item in obj["connected_organizations"]] if obj.get("connected_organizations") is not None else None,
