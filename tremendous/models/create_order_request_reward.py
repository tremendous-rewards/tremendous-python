...
class CreateOrderRequestReward(BaseModel):
    """
    ...
    custom_fields: Optional[List[CreateOrderRequestRewardCustomFieldsInner]] = None
    ...
    delivery: Optional[CreateOrderRequestRewardDelivery] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateOrderRequestReward from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateOrderRequestReward from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "custom_fields": [CreateOrderRequestRewardCustomFieldsInner.from_dict(_item) for _item in obj["custom_fields"]] if obj.get("custom_fields") is not None else None,
            "language": obj.get("language"),
            "delivery": CreateOrderRequestRewardDelivery.from_dict(obj["delivery"]) if obj.get("delivery") is not None else None
        })
        return _obj
