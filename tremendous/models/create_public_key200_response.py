...
class CreatePublicKey200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePublicKey200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePublicKey200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "public_key": PublicKeysResponsePublicKeysInner.from_dict(obj["public_key"]) if obj.get("public_key") is not None else None
        })
        return _obj
