...
class CreateConnectedOrganizationMemberSession200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateConnectedOrganizationMemberSession200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateConnectedOrganizationMemberSession200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "connected_organization_member_session": CreateConnectedOrganizationMemberSession200ResponseConnectedOrganizationMemberSession.from_dict(obj["connected_organization_member_session"]) if obj.get("connected_organization_member_session") is not None else None
        })
        return _obj
