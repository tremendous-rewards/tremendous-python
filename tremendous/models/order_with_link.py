...
from tremendous.models.str import str
...
class OrderWithLink(BaseModel):
    ...
    rewards: Optional[List[RewardWithLink]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rewards": [RewardWithLink.from_dict(_item) for _item in obj["rewards"]] if obj.get("rewards") is not None else None
        })
        return _obj
