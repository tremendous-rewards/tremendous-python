...
class Campaign(BaseModel):
    ...
    products: List[CampaignBaseProductsInner] = Field(description="List of IDs of products (different gift cards, charity, etc.) that are available in this campaign.  On write, the special value `ALL_FEE_FREE` stands for every product in your catalog that carries no fee at the time of the call. ")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if auto_add_product_rule (nullable) is None
        # and model_fields_set contains the field
        if self.auto_add_product_rule is None and "auto_add_product_rule" in self.model_fields_set:
            _dict['auto_add_product_rule'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products": [CampaignBaseProductsInner.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None,
