...
class SingleRewardOrderReward(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SingleRewardOrderReward from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SingleRewardOrderReward from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "custom_fields": [SingleRewardOrderRewardCustomFieldsInner.from_dict(_item) for _item in obj["custom_fields"]] if obj.get("custom_fields") is not None else None,
