...
class CreateOrganization200ResponseOrganization(BaseModel):
    ...
    api_key: Optional[StrictStr] = Field(default=None, description="The API key for the created organization. This property is only returned when `with_api_key` is set to `true`. ")
    __properties: ClassVar[List[str]] = ["id", "name", "website", "status", "created_at", "api_key"]
