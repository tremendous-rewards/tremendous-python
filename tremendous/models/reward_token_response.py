...
class RewardTokenResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RewardTokenResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RewardTokenResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "reward": RewardTokenResponseReward.from_dict(obj["reward"]) if obj.get("reward") is not None else None
        })
        return _obj
