...
class ListRewards200ResponseRewardsInnerValue(BaseModel):
    ...
    currency_code: StrictStr = Field(description="Currency of the reward")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListRewards200ResponseRewardsInnerValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListRewards200ResponseRewardsInnerValue from a dict"""
        if obj is None:
            return None
